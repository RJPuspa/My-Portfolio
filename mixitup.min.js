      ...
      for (g = 0; (r = m[g]) && (!(g > 0) || s); g++)
        r.id ? (d = r.id) : ((d = "MixItUp" + n.randomHex()), (r.id = d)),
          e.instances[d] instanceof e.Mixer
            ? ((l = e.instances[d]),
              (!i || (i && i.debug && i.debug.showWarnings !== !1)) && console.warn(e.messages.warningFactoryPreexistingInstance()))
    ...
    n.extend(e.Control.prototype, {
      ...
      removeBinding: function (t) {
        ...
        this.callActions("beforeRemoveBinding", arguments),
          ...
          n.bound.length < 1 &&
            (n.unbindClick(), (a = e.controls.indexOf(n)), e.controls.splice(a, 1), "active" === n.status && n.renderStatus(n.el, "inactive")),
      ...
      update: function (t, n) {
        ...
        a.callActions("beforeUpdate", arguments),
          ...
          a.pending > 0 ||
            ("live" === a.status
              ? a.updateLive(t, n)
              : ((i.sort = a.sort), (i.filter = a.filter), a.callFilters("actionsUpdate", i, arguments), a.parseStatusChange(a.el, t, i, n)),
    ...
    n.extend(e.Mixer.prototype, {
      ...
      attach: function (a, i, o, r) {
        ...
        s.config.controls.enable &&
          (s.initControls(), s.buildToggleArray(null, s.state), s.updateControls({ filter: s.state.activeFilter, sort: s.state.activeSort })),
          s.parseEffects(),
      ...
      getInitialState: function () {
        ...
        return (
          (a = t.callFilters("operationGetInitialState", a, [n])), (t.lastOperation = a), a.newFilter && t.filterOperation(a), (n = t.buildState(a))
        );
      },
        ...
        if (t.toRemove.length)
          for (r = 0; (o = t.show[r]); r++)
            t.toRemove.indexOf(o) > -1 &&
              (t.show.splice(r, 1), (a = t.toShow.indexOf(o)) > -1 && t.toShow.splice(a, 1), t.toHide.push(o), t.hide.push(o), r--);
      ...
      parseEffects: function () {
        ...
        for (n in e.transformDefaults)
          e.transformDefaults[n] instanceof e.TransformData &&
            (t.parseEffect(n, a, t.effectsIn, t.transformIn), t.parseEffect(n, i, t.effectsOut, t.transformOut, !0));
      ...
      getStartMixData: function (n) {
        ...
        (n.startX = o.left),
          ...
          (n.startHeight = a.incPadding
            ? o.height
            : o.height - parseFloat(i.paddingTop) - parseFloat(i.paddingBottom) - parseFloat(i.borderTop) - parseFloat(i.borderBottom)),
          (n.startWidth = a.incPadding
            ? o.width
            : o.width - parseFloat(i.paddingLeft) - parseFloat(i.paddingRight) - parseFloat(i.borderLeft) - parseFloat(i.borderRight)),
      ...
      getFinalMixData: function (e) {
        ...
        e.willChangeLayout &&
          (n.removeClass(a.dom.container, e.newContainerClassName), n.addClass(a.dom.container, a.config.layout.containerClassName)),
        ...
        for (n.callActions("beforeGetTweenData", arguments), u = 0; (a = t.show[u]); u++)
          for (
            i = t.showPosData[u],
              ...
              a.isShown
                ? ((i.posIn.x = i.startPosData.x - i.interPosData.x), (i.posIn.y = i.startPosData.y - i.interPosData.y))
      ...
      moveTargets: function (t) {
        ...
        a.config.animation.animateResizeContainer &&
          ((a.dom.parent.style[e.features.transitionProp] =
            "height " + a.config.animation.duration + "ms ease, width " + a.config.animation.duration + "ms ease "),
          requestAnimationFrame(function () {
          ...
          t.willChangeLayout &&
            (n.removeClass(a.dom.container, a.config.layout.ContainerClassName), n.addClass(a.dom.container, t.newContainerClassName)),
          ...
          (r =
            ...
            (!!(("none" !== t && e) || a.x !== i.x || a.y !== i.y) ||
              (!!o.config.animation.animateResizeTargets &&
                (a.width !== i.width || a.height !== i.height || a.marginRight !== i.marginRight || a.marginTop !== i.marginTop)))),
      ...
      cleanUp: function (t) {
        var a = this,
          ...
          l = -1;
        for (
          a.callActions("beforeCleanUp", arguments), a.targetsMoved = a.targetsImmovable = a.targetsBound = a.targetsDone = 0, l = 0;
          (i = t.show[l]);
          l++
        )
          i.cleanUp(), i.show();
      ...
      parseMultimixArgs: function (t) {
        ...
        for (i.animate = a.config.animation.enable, i.command = new e.CommandMultimix(), r = 0; r < t.length; r++)
          (o = t[r]),
            null !== o &&
              ("object" == typeof o ? n.extend(i.command, o) : "boolean" == typeof o ? (i.animate = o) : "function" == typeof o && (i.callback = o));
        return (
      ...
      getDataOperation: function (t) {
        var a = this,
          ...
          o = [];
        if (
          ((i = a.callFilters("operationUnmappedGetDataOperation", i, arguments)), a.dom.targets.length && !(o = a.state.activeDataset || []).length)
        )
      ...
      diffDatasets: function (t) {
        ...
        for (
          u && ((f = f || a.config.layout.siblingAfter), f && u.appendChild(a.dom.document.createTextNode(" ")), a.insertDatasetFrag(u, f, r)), m = 0;
          (s = t.startDataset[m]);
          m++
        )
      ...
      toggleOff: function () {
        var t = this,
          ...
          i = "";
        return (
          (t.isToggling = !0), a > -1 && t.toggleArray.splice(a, 1), (i = t.getToggleSelector()), t.multimix({ filter: i }, e.animate, e.callback)
        );
      },
      sort: function () {
        var t = this,
          ...
          t.isBusy
            ...
            : ((n = t.getOperation(o.command)),
              t.config.controls.enable &&
                (o.command.filter && !t.isToggling && ((t.toggleArray.length = 0), t.buildToggleArray(n.command)),
    ...
    n.extend(e.Target.prototype, {
      ...
      render: function (t) {
        ...
        return (
          ...
          s && "object" == typeof s && n.isElement(s)
            ? (o = s)
            : "string" == typeof s && ((r = document.createElement("div")), (r.innerHTML = s), (o = r.firstElementChild)),
      ...
      applyTween: function (t, n) {
        var a = this,
          ...
          c = -1;
        for (
          a.callActions("beforeApplyTween", arguments), l.x = r.x, l.y = r.y, 0 === n ? a.hide() : a.isShown || a.show(), c = 0;
      ...
      getPosData: function (n) {
        ...
        return (
          ...
          a.mixer.config.animation.animateResizeTargets &&
            ((i = t.getComputedStyle(a.dom.el)), (r.marginBottom = parseFloat(i.marginBottom)), (r.marginRight = parseFloat(i.marginRight))),
      ...
      cleanUp: function () {
        ...
        t.callActions("beforeCleanUp", arguments),
          ...
          t.mixer.config.animation.animateResizeTargets &&
            ((t.dom.el.style.width = ""), (t.dom.el.style.height = ""), (t.dom.el.style.marginRight = ""), (t.dom.el.style.marginBottom = "")),
